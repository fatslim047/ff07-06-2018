...
public class NounsGenerator {
	...
	public NounsGenerator(String preprocessedFile,String nounfile) {
		this.preprocessedFile = new File(preprocessedFile);
		nouns = new ArrayList<String>();
		nounsFile = new File(nounfile);
	...
	public void generateAspects() throws IOException {
		...
		if (!parsedFile.exists()) {
			...
			BufferedWriter bw = new BufferedWriter(new FileWriter(nounsFile.getAbsoluteFile()));
